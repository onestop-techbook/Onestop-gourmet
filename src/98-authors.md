...
<div class="author-profile">
    ...
    <div>
        <div>
            <b>ロジウム</b>
            <a href="https://x.com/_rhodium_/">Twitter(X)@_rhodium_</a>
        </div>
        <div>
            サークル名：共鳴効果
            <a href="https://resonanceeffect.booth.pm/">Booth</a>
        </div>
    </div>
</div>
<p style="margin-top: 0.5em; margin-bottom: 2em;">
...
<p style="margin-top: 0.5em; margin-bottom: 2em;">
毎日同じものを食べると体を壊しました。メンタルが耐えれても体は耐えれないようです。とある音ゲーのプロゲーマーやってます。
</p>
